...
//#pragma once
#ifndef NANITE_DEFINATIONS__
#define NANITE_DEFINATIONS__
...
#define NANITE_MAX_CLUSTER_INSTANCES_PER_PAGE_BITS			11
#define NANITE_MAX_CLUSTER_INSTANCES_PER_PAGE_MASK			((1 << NANITE_MAX_CLUSTER_INSTANCES_PER_PAGE_BITS) - 1)
#define NANITE_MAX_CLUSTER_INSTANCES_PER_PAGE				( 1 << NANITE_MAX_CLUSTER_INSTANCES_PER_PAGE_BITS)
...
// TiX: FLOAT4S split to 2: PackedCluster and PackedClusterInstance
#define NANITE_NUM_PACKED_CLUSTER_FLOAT4S					3
#define NANITE_NUM_PACKED_CLUSTER_INSTANCE_FLOAT4S			6
