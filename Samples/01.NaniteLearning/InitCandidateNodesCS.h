...
class FInitCandidateNodesCS : public FComputeTask
{
public:
	FInitCandidateNodesCS();
	virtual ~FInitCandidateNodesCS();
...
typedef TI_INTRUSIVE_PTR(FInitCandidateNodesCS) FInitCandidateNodesCSPtr;
