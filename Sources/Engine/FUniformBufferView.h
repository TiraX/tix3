...
namespace tix
{
	BEGIN_UNIFORM_BUFFER_STRUCT(FViewUniformBuffer)
		DECLARE_UNIFORM_BUFFER_STRUCT_MEMBER(FMat4, VP)
		...
		DECLARE_UNIFORM_BUFFER_STRUCT_MEMBER(FMat4, ShadowVP)
		DECLARE_UNIFORM_BUFFER_STRUCT_MEMBER(FFloat4, ShadowParam)
