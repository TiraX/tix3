...
namespace tix
{
	...
	//inline EPrimitiveType GetPrimitiveType(const TString& name)
	//{
	...
	{
		ReturnEnumValue(name, EINSSEG_TRANSFORM0);
		ReturnEnumValue(name, EINSSEG_TRANSFORM1);
		ReturnEnumValue(name, EINSSEG_TRANSFORM2);
		ReturnEnumValue(name, EINSSEG_CUSTOM0);

		return EINSSEG_TRANSFORM0;
	}
	...
	inline E_PIXEL_FORMAT GetPixelFormat(const TString& name)
	{
		...
		ReturnEnumValue(name, EPF_R16U);
		ReturnEnumValue(name, EPF_RG16U);
		ReturnEnumValue(name, EPF_RGBA16U);
		ReturnEnumValue(name, EPF_R32U);
		ReturnEnumValue(name, EPF_RG32U);
		ReturnEnumValue(name, EPF_RGB32U);
		ReturnEnumValue(name, EPF_RGBA32U);
		ReturnEnumValue(name, EPF_R10G10B10A2U);
